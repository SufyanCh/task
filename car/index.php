			...
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						...
						<img src="<?php echo base_url();?>assets/images/g1.jpg" alt=" " class="img-responsive" />
						...
						<div class="sreen-gallery-cursual">
						       ...
						       <div id="owl-demo" class="owl-carousel">
							      <div class="item-owl">
									 ...
									 <div class="item-owl">
					                	    <div class="test-review">
						                	  <img src="<?php echo base_url();?>assets/images/s4.jpg" class="img-responsive" alt=""/>
											  <h5>$600</h5>
					                	    </div>
					                </div>
									<div class="item-owl">
					                 ...
					                 <div class="item-owl">
					                		<div class="test-review">
						                	  <img src="<?php echo base_url();?>assets/images/s5.jpg" class="img-responsive" alt=""/>
											  <h5>$500</h5>
					                	    </div>
					                </div>
									 <div class="item-owl">
		...
		<div class="container">
				...
				<div class="col-md-4 agileits_service_grid_btm_left">
					<div class="agileits_service_grid_btm_left1">
						...
						<img src="<?php echo base_url();?>assets/images/s3.jpg" alt=" " class="img-responsive">
					</div>
				</div>
				<div class="col-md-4 agileits_service_grid_btm_left">
					<div class="agileits_service_grid_btm_left1">
				...
				<div class="col-md-4 agileits_service_grid_btm_left">
					<div class="agileits_service_grid_btm_left1">
						...
						<img src="<?php echo base_url();?>assets/images/s1.jpg" alt=" " class="img-responsive">
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
	...
	<div class="container">
		...
		<div class="inner_w3l_agile_grids">
			...
			<div class="col-md-4 gal-gd wow fadeInRight animated" data-wow-delay=".5s">
				<a href="#image-8">
					<div class="nd-wrap nd-style-8">
						<img src="<?php echo base_url();?>assets/images/g8.jpg" class="img-responsive" alt=" " />
						<div class="nd-content">
				<div class="nd-content_inner">
					<div class="nd-content_inner1">
						<h4 class="nd-title">Car Rental</h4>
...
<!-- //gallery -->
	<div class="lb-overlay" id="image-1">
		<img src="<?php echo base_url();?>assets/images/g1.jpg" alt="image1" />
		<div class="gal-info">							
			<h3>Car Rental</h3>
	...
	<div class="lb-overlay" id="image-2">
		<img src="<?php echo base_url();?>assets/images/g2.jpg" alt="image1" />
		<div class="gal-info">							
			<h3>Car Rental</h3>
				<p>Neque porro quisquam est, qui dolorem ipsum 
					quia dolor sit amet, consectetur, adipisci velit, 
	...
	<div class="lb-overlay" id="image-3">
		<img src="<?php echo base_url();?>assets/images/g3.jpg" alt="image1" />
		<div class="gal-info">							
			<h3>Car Rental</h3>
				<p>Neque porro quisquam est, qui dolorem ipsum 
					quia dolor sit amet, consectetur, adipisci velit, 
	...
	<div class="lb-overlay" id="image-4">
		<img src="<?php echo base_url();?>assets/images/g4.jpg" alt="image1" />
		<div class="gal-info">							
			<h3>Car Rental</h3>
				<p>Neque porro quisquam est, qui dolorem ipsum 
					quia dolor sit amet, consectetur, adipisci velit, 
	...
	<div class="lb-overlay" id="image-5">
		<img src="<?php echo base_url();?>assets/images/g5.jpg" alt="image1" />
		<div class="gal-info">							
			<h3>Car Rental</h3>
				<p>Neque porro quisquam est, qui dolorem ipsum 
					quia dolor sit amet, consectetur, adipisci velit, 
	...
	<div class="lb-overlay" id="image-6">
		<img src="<?php echo base_url();?>assets/images/g6.jpg" alt="image1" />
		<div class="gal-info">							
			<h3>Car Rental</h3>
				<p>Neque porro quisquam est, qui dolorem ipsum 
					quia dolor sit amet, consectetur, adipisci velit, 
	...
	<div class="lb-overlay" id="image-7">
		<img src="<?php echo base_url();?>assets/images/g7.jpg" alt="image1" />
		<div class="gal-info">							
			<h3>Car Rental</h3>
				<p>Neque porro quisquam est, qui dolorem ipsum 
					quia dolor sit amet, consectetur, adipisci velit, 
	...
	<div class="lb-overlay" id="image-8">
		<img src="<?php echo base_url();?>assets/images/g8.jpg" alt="image1" />
		<div class="gal-info">							
			<h3>Car Rental</h3>
				<p>Neque porro quisquam est, qui dolorem ipsum 
					quia dolor sit amet, consectetur, adipisci velit, 
