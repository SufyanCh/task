					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="#contact" class="hvr-underline-from-center scroll">Contact Us</a></li>
                                                        <li><a href="<?php echo base_url();?>user/register" class="hvr-underline-from-center scroll">Register</a></li>
                                                           <li><a href="<?php echo base_url();?>user/login" class="hvr-underline-from-center scroll">Login</a></li>
						</ul>
					</div>
					<div class="clearfix"> </div>	
				</nav>
